...
export const TAB1_PARKING_LOTS: ParkingLot[] = [
    {
        ...
        category: 'parking',
        capacity: { normal: 500, ev: 20, motorcycle: 100 }, // Increased capacity to look like "317 empty"
        available: { normal: 317, ev: 10, motorcycle: 50 },
        ...
        hours: '',
        hasEVCharger: true,
        userTypes: 'นักศึกษา • บุคลากร • บุคคลภายนอก',
        price: 10,
        priceUnit: 'ต่อชั่วโมง',
        promotion: 'จอดฟรี 1 ชม.',
        note: 'รองรับผู้มาติดต่อมหาลัย',
        supportedTypes: ['normal', 'ev', 'motorcycle'],
        schedule: [
            { days: [], open_time: '', close_time: '', cron: { open: '0 0 * * *', close: '0 24 * * 5' } } // Example: Open until 24:00 Friday
        ],
    ...
    },
    {
        ...
        category: 'parking',
        capacity: { normal: 100, ev: 20, motorcycle: 20 },
        available: { normal: 40, ev: 5, motorcycle: 10 },
        floors: ['G'],
        mapX: 0, mapY: 0,
        lat: 13.650207,
        lng: 100.495112,
        ...
        note: 'รองรับผู้มาติดต่อมหาลัย',
        supportedTypes: ['ev'],
        schedule: [{ days: [], open_time: '', close_time: '', cron: { open: '0 5 * * *', close: '0 20 * * *' } }],
    ...
    },
    {
        ...
        name: 'FIBO (N3)',
        category: 'parking',
        capacity: { normal: 80, ev: 0, motorcycle: 50 },
    ...
    {
        id: 'visitor_bldg_1',
        name: 'อาคารเรียนรวม 1 (Learning Center 1)',
        category: 'building',
